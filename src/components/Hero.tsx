        ...
        >
          ...
          >
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight">
              ...
              <span className="gradient-text block" data-testid="hero-name">{t('hero.name')}</span>
            </h1>
            
            <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed" data-testid="hero-description">
              {t('hero.description')}
            </p>
